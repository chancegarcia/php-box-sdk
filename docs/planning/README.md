...
This directory contains trackers, roadmaps, and architectural plans for the Box PHP SDK.
...
## [v1.0 Architecture and Strategy](v1/)

Canonical references for the v1.0 design:

- **[Strategy and Contracts](v1/strategy-and-contracts.md)**: Core v1.0 strategy (Hardened).
- **[Architecture Rules](v1/architecture-rules.md)**: Mandatory rules for v1.0 implementation.
- **[Decision Index](v1/decision-index.md)**: Log of architectural decisions.

## Completed Trackers (Retained for Traceability)

These documents track completed steps of the v1.0 foundation work:

- [Step 7: Foundation Refinement](07-foundation-refinement.md)
...
- [v1.0 Overview](v1/overview.md): High-level goals (mostly superseded by Strategy and Contracts).
- [API Coverage Audit](v1/api-coverage-audit.md): Initial assessment.
- [Interface and Model Audit](v1/interface-and-model-audit.md): Initial review.
